 ...
 */
final class Version20251114154020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prices DROP source');
        $this->addSql('ALTER TABLE prices RENAME COLUMN average_price TO market_price_eur');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prices ADD source VARCHAR(20) NOT NULL');
